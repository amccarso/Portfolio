/* Austin McCarson, Fall 2015
 ...
 Truncates stringa, converts string to lowercase
 Determines if string is a palindrome
 Finds largest palindrome and size of largest palindrome
...
//returns size of largest palindrome
...
void PalindromeFinder::truncateToLargestPalindrome(string& inputString){
    ...
    //  simpler to understand what it's doing than the more efficient algorithms.
